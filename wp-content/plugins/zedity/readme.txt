...
Zedity lets you create posts and pages very easily and quickly with professional results and absolutely no coding skills required!

== Description ==
Zedity extends the standard WordPress editor enabling you to create posts and pages as naturally as writing on paper! With absolutely no coding skills required, creating professional content becomes incredibly easy and quick for anyone!

>We recommend all users to **update to the latest version 6** to take advantage of the brand new user interface, support for touchscreen devices, interactive tutorials and other [new features]( https://zedity.com/plugin/wpfeatures ). If you're still on versions 5.x, 4.x and other obsolete ones, you should update now (for free, of course). Enjoy the latest Zedity!

[youtube https://www.youtube.com/watch?v=8Ws7OzSdDhs]

Here are four major advantages of using Zedity:

* **Easy for anyone**: no more need to deal with HTML, CSS and JavaScript code! Zedity enables you to create your posts and pages entirely visually, as naturally as sketching on a piece of paper, generating HTML5 code automatically for you.
...
*   [Official site](https://zedity.com): Zedity is currently available for both WordPress, either as a Free or Premium Plugin, and for standalone Online Editor for those now using WordPress. Find all the information on the Zedity site.
...
NOTE: if you use Safari and after the download you can't find the .zip file, it may be your browser that unzips it automatically (and you'd see a folder with many files). If so, you can right click on the unzipped folder and compress it back. Your .zip file is now ready to be installed.
